...
Процедура Справка(Команда)
	ОткрытьФорму("Обработка.НачальнаяСтраница.Форма.Справка");
КонецПроцедуры
...
&НаКлиенте
Процедура ЗатратыНаПроекты(Команда)
	ОткрытьФорму("Отчет.ЗатратыНаПроекты.Форма", Новый Структура("СформироватьПриОткрытии", Истина));
КонецПроцедуры

&НаКлиенте
Процедура ЗатратыНаТО(Команда)
	ОткрытьФорму("Отчет.ЗатратыНаАвтомобиль.Форма", Новый Структура("СформироватьПриОткрытии", Истина));
КонецПроцедуры

&НаКлиенте
Процедура НезавершенныеПроекты(Команда)
	ОткрытьФорму("Отчет.НезавершенныеПроекты.Форма", Новый Структура("СформироватьПриОткрытии", Истина));
КонецПроцедуры
