...
Процедура ЗапуститьОбновление() Экспорт
	...
	Константы.ВерсияКонфигурации.Установить(Версия);
...
Функция ДобавитьХарактеристикуЦена(ДетальПроекта)
	...
	НоваяСтрока.Характеристика = Справочники.ФизическиеХарактеристики.Ценаруб;
	Возврат НоваяСтрока;
КонецФункции

Функция ДобавитьХарактеристикуКоличество(ДетальПроекта)
	НоваяСтрока = ДетальПроекта.Характеристики.Добавить();
	НоваяСтрока.Характеристика = Справочники.ФизическиеХарактеристики.Количествошт;
	Возврат НоваяСтрока;
КонецФункции
