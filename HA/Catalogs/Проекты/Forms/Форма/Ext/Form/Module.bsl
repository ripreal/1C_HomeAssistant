// Current data for table Details. Allow to etablish whether formula has been choosed from a 
// active row or by click on Add button.
&НаКлиенте
Перем ТекСтрокаФормулы;

// Используется в команда ИзменитьДеталь
&НаКлиенте
